========================================================================
    APLICACIÓN DE CONSOLA: Comparacion de numeros enteros Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Comparacion de numeros enteros.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Comparacion de numeros enteros.


Comparacion de numeros enteros.vcxproj
...
Comparacion de numeros enteros.vcxproj.filters
...
Comparacion de numeros enteros.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Comparacion de numeros enteros.pch y un archivo de tipos precompilados llamado StdAfx.obj.
